/*
 * Adapted from pico_w/wifi/tls_client/tls_common.c of
 * https://github.com/raspberrypi/pico-examples/blob/eca13acf57916a0bd5961028314006983894fc84/pico_w/wifi/tls_client/tls_common.c
 * Additional credit to Micheal Bell for https_get:
...
static err_t tls_client_connected(void *arg, struct altcp_pcb *pcb, err_t err) {
    ...
    err = altcp_write(state->pcb, state->http_request, strlen(state->http_request),
                      TCP_WRITE_FLAG_COPY);
    if (err != ERR_OK) {
